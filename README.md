...
| # | Feature | Description |
|---|---|---|
| 1 | **Computer Use** (macOS) | Give any agent eyes and hands on your Mac. One-click enable per tab — agents can read the screen, click UI elements, type, scroll, open apps, and control Chrome. Includes a built-in **Computer Operator** CoWorker and a permissions panel for Accessibility + Screen Recording. |
